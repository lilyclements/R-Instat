...
load_R_Instat_packages <- function() {
  ...
  packs_to_load <- c("purrr", "plyr", "tidyr", "dplyr", "instatCalculations", "ggplot2", "ggthemes", "svglite", "ggfortify", "PCICt", "sp", "ggmosaic", "wakefield", "circular", "latticeExtra", "texmex", "mc2d")
